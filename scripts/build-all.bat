...
docker build -t %REGISTRY%/auth-service:%TAG% -f services/auth_service/Dockerfile services/auth_service
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built auth-service

echo Building irrigation-service...
docker build -t %REGISTRY%/irrigation-service:%TAG% -f services/irrigation_service/Dockerfile services/irrigation_service
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built irrigation-service

echo Building forecasting-service...
docker build -t %REGISTRY%/forecasting-service:%TAG% -f services/forecasting_service/Dockerfile services/forecasting_service
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built forecasting-service

echo Building optimization-service...
docker build -t %REGISTRY%/optimization-service:%TAG% -f services/optimize_service/Dockerfile services/optimize_service
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built optimization-service

echo Building iot-service...
docker build -t %REGISTRY%/iot-service:%TAG% -f services/iot_service/Dockerfile services/iot_service
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built iot-service

echo Building crop-health-service...
docker build -t %REGISTRY%/crop-health-service:%TAG% -f services/crop_health_and_water_stress_detection/Dockerfile services/crop_health_and_water_stress_detection
if %errorlevel% neq 0 exit /b %errorlevel%
...
echo Building web...
docker build -t %REGISTRY%/web:%TAG% -f web/Dockerfile web
if %errorlevel% neq 0 exit /b %errorlevel%
echo [OK] Built web
