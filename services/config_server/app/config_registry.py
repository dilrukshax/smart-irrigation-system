...
def _build_docker_profile() -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        "auth_service": {
            ...
            "ENSURE_BOOTSTRAP_AUTHORITY": _e("ENSURE_BOOTSTRAP_AUTHORITY", "true"),
            "AUTHORITY_BOOTSTRAP_USERNAME": _e("AUTHORITY_BOOTSTRAP_USERNAME", "authority"),
            "AUTHORITY_BOOTSTRAP_EMAIL": _e("AUTHORITY_BOOTSTRAP_EMAIL", "authority@smartirrigation.com"),
            "AUTHORITY_BOOTSTRAP_PASSWORD": _e("AUTHORITY_BOOTSTRAP_PASSWORD", "authority123"),
            "AUTHORITY_BOOTSTRAP_FULL_NAME": _e("AUTHORITY_BOOTSTRAP_FULL_NAME", "System Authority"),
            "AUTHORITY_BOOTSTRAP_SCHEME_IDS": _e("AUTHORITY_BOOTSTRAP_SCHEME_IDS", "scheme-default"),
            "AUTHORITY_BOOTSTRAP_RESET_PASSWORD": _e("AUTHORITY_BOOTSTRAP_RESET_PASSWORD", "false"),
        },
        "irrigation_service": {
            "HOST": "0.0.0.0",
            "PORT": "8002",
